...
namespace ArduinoJson {
    ...
    class JsonVariant : public Internals::JsonVariantBase<JsonVariant> {
        ...
        friend
        class Internals::JsonSerializer;
    ...
    public:
        ...
        // Set binary type of variant (1 means messagepack enabled variand)
        inline void setParserType(uint8_t value) {_parserType = value;}
        // Gets binary type of variant (1 means messagepack enabled variand)
        inline uint8_t getParserType() { return _parserType;}
    ...
    private:
        ...
        // Use MessagePack conversion with raw values
        uint8_t _parserType;
