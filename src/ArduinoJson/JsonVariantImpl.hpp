    ...
    inline T JsonVariant::variantAsInteger() const {
        ...
        switch (_type) {
            ...
            case JSON_UNPARSED:
                switch (_parserType)
                {
                    case PARSER_TYPE_JSON: return parseInteger<T>(_content.asString);
                    case PARSER_TYPE_MESSAGEPACK: return parseBinaryInteger<T>(_content.asString);
                }
            default:
    ...
    inline T JsonVariant::variantAsFloat() const {
        ...
        switch (_type) {
            ...
            case JSON_UNPARSED:
                switch (_parserType)
                {
                    case PARSER_TYPE_JSON: return parseFloat<T>(_content.asString);
                    case PARSER_TYPE_MESSAGEPACK: return parseBinaryFloat<T>(_content.asString);
                }
            default:
